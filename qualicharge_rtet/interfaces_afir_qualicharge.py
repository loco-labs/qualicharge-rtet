...
def filter_stations_parcs(rtet_edges, rtet_nodes, stations, pmax=0, pcum=0, simple=False) -> pd.DataFrame:
    """Extraction et export des stations et parcs de recharge d'un graphe"""
    ...
    stations_afir = creation_pandas_stations(stations, nature="station_irve", first_id=first_id, source="qualicharge")
